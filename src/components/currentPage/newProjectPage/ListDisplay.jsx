    ...
    >
      {list.map((item, index) => (
        <div
          ...
          className="flex flex-row justify-evenly text-stone-700 text-base font-semibold h-min border-stone-900 border-2 rounded-full px-0 py-0 mt-2 text-center cursor-pointer transform transition-transform duration-75 hover:scale-105"
        >
          {item}
